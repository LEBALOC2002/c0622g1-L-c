function kiem_tra() {
    ...
    if (bmi < 16) 
        result = "Gầy độ 3. Ăn thật nhiều vào nhé SHOP yêu <3" + "<img src = 'https://i.pinimg.com/originals/3b/97/63/3b97635b6bd4a5bfc436fbd3908f05e0.gif' width='100' height= '100'>";
    else if (bmi < 20)
        result = "Gầy độ 2"
    else if (bmi < 30)
        result = "Gầy độ 1"
